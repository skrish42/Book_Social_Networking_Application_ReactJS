...
const NavBar = () => {
  ...
  return (
    <>
        <div className="navbar bg-transparent backdrop-blur-md top-0 z-50 fixed w-full text-black px-5" style={{backgroundColor: '#D3D3D3'}}>
            <div className="navbar-start">
                ...
                <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-[#0B666A] rounded-box w-52">
                    ...
                    <li><Link to="/books">Book Shelve</Link></li>
