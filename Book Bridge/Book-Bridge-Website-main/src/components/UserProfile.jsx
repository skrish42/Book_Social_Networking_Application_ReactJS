...
const UserProfile = () => {
    ...
    <>
        ...
        <div className="flex justify-center items-center">
            <div className="flex md:flex sm:flex justify-center items-center text-black">
                ...
                <div className="w-4/5 p-8 shadow-md mt-20">
                    ...
                    <div className="rounded  shadow p-6">
                        <div className="pb-6">
                            <label htmlFor="name" className="font-semibold text-black-700 block pb-1">Name</label>
                            <div className="flex">
                                <input disabled id="username" className="border-1  rounded-r px-4 py-2 w-full" type="text" value={data.name} />
                            </div>
                        </div>
                            <div className="pb-4">
                            <label htmlFor="about" className="font-semibold text-black-700 block pb-1">Email</label>
                        ...
                        <div className="w-full p-8 mx-2 flex justify-start">
                            <Link to='/addbooks' className='btn glass text-black'>Add Books</Link>                          
                        </div>
                    </div>
