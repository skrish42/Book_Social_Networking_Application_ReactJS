...
const ChatMessage = () => {
  ...
  return (
    <>
      <NavBar />
      <div className="container mt-5 flex justify-center items-center mx-auto shadow-lg rounded-lg h-[100vh]" style={{ backgroundColor: 'white' }}>
        
        <div className="flex flex-row justify-center " style={{ backgroundColor: '#A9A9A9', fontSize: '3vh'}}>
          <div className="min-w-[80vw] min-h-[80vh] px-5 flex flex-col justify-between">
          <p className='text-black'>Chatting with : {receiver_email}</p>
                  ...
                  <div
                    className={`${
                      message.sender_email === sender_email
                        ? 'mr-2 bg-gray-400 rounded-bl-3xl rounded-tl-3xl rounded-tr-xl text-black'
                        : 'ml-2 bg-gray-400 rounded-br-3xl rounded-tr-3xl rounded-tl-xl text-black'
                    } py-3 px-4`}
                  >
                    {message.message}
                  </div>
