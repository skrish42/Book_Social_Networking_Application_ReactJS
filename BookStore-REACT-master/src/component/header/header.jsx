            ...
            items.push(
                <div className={i === 1 ? 'carousel-item active' : 'carousel-item'} >
                    ...
                    <div className="img-text">
                        ...
                        <p className="lg-5" style={{fontSize:'7vh'}}>
                            Read. Review. Relate. Your Book Lover's Paradise !! 
                        </p>
                        <p style={{fontSize:'vh'}}>A Platform Connecting Bookworms Worldwide - Discover, Discuss, Share</p>
                    </div>
                </div>
            )
        }
